...
function ItemPage(props) {
    ...
    const dispatchAddItem = (value,AmountOfPaint,BoxType) =>{
        ...
        if(stateAmountOfPaint==-1){
            alert("Enter the fuel tank volume in the field please!")
            return
        }
        else if(stateBoxType == 'BOX TYPE'){
            alert("Select the type of suspension please!")
            return
        }
        else{
                    ...
                    <div className="item-box__info">
                        ...
                        <div className="item-bottom">
                            ...
                            <div className="item-features">
                                <Input type="number"  placeholder="Fuel tank volume:" func={(value)=>onStateAmountOfPaint(value)}/>

                                <Select data={["Hydraulic", "Pneumatic", "Magnetic"]} width={"235px"}
                                        value={"Type of suspension:"}  id={"catalog-page-type"}
